...
import styles from './EditAssetsStyle';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);
import inputStyles from '../../../../components/Input/InputStyle';
  ...
  render() {
    ...
    return (
      <View auto column className={ styles.container }>
        { showOnboarding && (
          <View align="center" justify="center" className={ styles.overlay }>
            <View column align="center" className={ styles.overlayWrapper }>
              <View align="center" justify="center" className={ styles.overlayImage }>
                {/*<Pie
                  height={ 87 }
                  width={ 87 }
              ...
              <View className={ styles.overlayHeader }><Text>Create your portfolio</Text></View>
              <View className={ styles.overlayText }>
                <Text>Enter the amount of each digital currency you own (or want to),
                then </Text><View className={ styles.emphasis }><Text>save</Text></View><Text> to start tracking.</Text>
              </View>
              <TouchableHighlight
                role="button"
        ...
        <View align="center" justify="space-between" className={ styles.header }>
          <View><Text>Total: { formatNumber(totalBalance, 'USD') }</Text></View>
          <TouchableHighlight
        ...
        <View className={ styles.currencies }>
...
class EditRow extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <View align="center" className={ styles.dot }>
        ...
        >
          <View className={ styles.currencyName }>{currency.name}</View>
          <View>
            <input
              type="number"
              min="0"
              ...
              onBlur={ this.onBlur }
            />
            <View align="center" className={ styles.symbol }>
