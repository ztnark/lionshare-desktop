    ...
    return (
      <View auto column className={ styles.container }>
        { showOnboarding && (
          <View align="center" justify="center" className={ styles.overlay }>
            <View column align="center" className={ styles.overlayWrapper }>
              ...
              <View className={ styles.overlayHeader }>Create your portfolio</View>
              <View className={ styles.overlayText }>
                Enter the amount of each digital currency you own (or want to),
                then <View className={ styles.emphasis }>save</View> to start tracking.
              </View>
              <View
                role="button"
        ...
        <View align="center" justify="space-between" className={ styles.header }>
          <View>Total: { formatNumber(totalBalance, 'USD') }</View>
          <View
